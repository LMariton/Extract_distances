##############################################################################################################
# This script allows to extract the minimum distance between each point of a layer and the lines of another one
# Example : minimum distance between each survey site and roads
# It returns a data table containing the point IDs and the values obtained in meters.
##############################################################################################################
